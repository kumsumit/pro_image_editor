...
import 'package:pro_image_editor/core/models/editor_configs/size_editor_configs.dart';
...
///   triggered.
class SizeEditorAppbar extends StatelessWidget implements PreferredSizeWidget {
  /// Creates an instance of `CropEditorAppbar`, a custom `AppBar` for the Blur
  /// Editor UI.
  const SizeEditorAppbar({
    super.key,
  ...
  final SizeEditorConfigs configs;
