...
class I18nSizeEditor {
  /// Creates an instance of [I18nSizeEditor] with customizable
  ...
  /// )
  /// ```
  const I18nSizeEditor({
    this.moveAndZoom = 'Zoom',
    this.bottomNavigationBarText = 'Resize',
  ...
  /// [I18nSizeEditor] with some properties updated while keeping the
  /// others unchanged.
  I18nSizeEditor copyWith({
    String? moveAndZoom,
